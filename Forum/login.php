...
else
{
	...
	if(isset($_POST['username'], $_POST['password']))
	{
		if(get_magic_quotes_gpc())
		{
			...
			$username = mysqli_real_escape_string(stripslashes($connect ,$_POST['username']));
		...
		$req = mysqli_query($connect, 'select password,id from users where username="'.$username.'"');
...
<div class="content">
<?php
$nb_new_pm = mysqli_fetch_array(mysqli_query($connect, 'select COUNT(*) as nb_new_pm from pm where (( user1read="no") or (user2read="no")) and id2="1"'));
...
<div class="box">
	...
	<div class="box_right">
    	<a href="list_pm.php">Your messages(<?php echo $nb_new_pm; ?>)</a> - <a href="profile.php?id=<?php 
...
?>
		<div class="foot"><a href="http://www.webestools.com/scripts_tutorials-code-source-26-simple-php-forum-script-php-forum-easy-simple-script-code-download-free-php-forum-mysqli.html">Simple PHP Forum Script</a> - <a href="http://www.webestools.com/">Webestools</a></div>
	</body>
</html>